...
pub fn default() -> HashMap<Mode, KeyTrie> {
    let normal = keymap!({ "Normal mode"
        ...
        "[" => { "Left bracket"
            ...
            "(" | ")" => select_prev_parenthesis,
            "{" | "}" => select_prev_curly_bracket,
            "[" | "]" => select_prev_square_bracket,
            "<" | ">" => select_prev_angle_bracket,
            "'" => select_prev_single_quote,
            "\"" => select_prev_double_quote,
            "`" => select_prev_backtick,
        ...
        "]" => { "Right bracket"
            ...
            "(" | ")" => select_next_parenthesis,
            "{" | "}" => select_next_curly_bracket,
            "[" | "]" => select_next_square_bracket,
            "<" | ">" => select_next_angle_bracket,
            "'" => select_next_single_quote,
            "\"" => select_next_double_quote,
            "`" => select_next_backtick,
